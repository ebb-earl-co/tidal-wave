...
$ docker run \
    ...
    --entrypoint "/bin/bash" \
    ghcr.io/ebb-earl-co/tidal-wave:latest
$ docker exec -it tidal-wave tidal_wave https://tidal.com/browse/album/...
$ docker exec -it tidal-wave tidal_wave https://tidal.com/browse/mix/...
$ docker exec -it tidal-wave tidal_wave https://tidal.com/browse/playlist/...
$ docker exec -it tidal-wave tidal_wave https://tidal.com/browse/track/...
```
## Development
