...
def requester_maker(
  ...
  return function(
    s=session, e=endpoint, i=identifier, u=url_end, h=headers, p=parameters, sc=subclass, cf=credits_flag
  )
...
request_albums: Callable[[Session, int], Optional[AlbumsEndpointResponseJSON]] = partial(
  requester_maker,
  endpoint="albums",
...
request_tracks: Callable[[Session, int], Optional[TracksEndpointResponseJSON]] = partial(
  requester_maker,
  endpoint="tracks",
  headers={"Accept": "application/json"},
...
request_credits: Callable[[Session, int], Optional[TracksCreditsResponseJSON]] = partial(
  requester_maker,
  endpoint="tracks",
  headers={"Accept": "application/json"},
...
request_stream: Callable[[Session, int, str], Optional[TracksLyricsResponseJSON]] = \
  lambda session, track_id, audio_quality: partial(
    ...
    endpoint="tracks",
    headers={"Accept": "application/json"},
    parameters={"audioquality": audio_quality, "playbackmode": "STREAM", "assetpresentation": "FULL"},
    url_end="/playbackinfopostpaywall",
    subclass=TracksEndpointStreamResponseJSON
  )()
  
request_videos: Callable[[Session, int], Optional[TracksEndpointResponseJSON]] = partial(
  requester_maker,
  endpoint="videos",
  headers={"Accept": "application/json"},
...
def get_album_id(session: Session, track_id: int) -> Optional[int]:                                                                            
  ...
  terj: Optional[TracksEndpointResponseJSON] = \
    request_tracks(session=session, identifier=track_id)
